...
function Header(){
    return(
        <div>
        <header>
        <div id="menu_container" class="menu_container" onClick={()=>{
        ...
        <div id="list_container" className="list_container">
            <ul className="list">
            <li><button className="list_link" onClick={()=>{
                var node1=document.getElementById("menu_container")
                var node2=document.getElementById("list_container")
                var a = ReactDOM.findDOMNode(node1)
                var b = ReactDOM.findDOMNode(node2)
                ...
                setTimeout(()=>{registered_container.classList.toggle("registered_transition");},5000)  
                registered_container.classList.toggle("registered_transition")
            }}>Add Selected Classes</button></li>
            <li><button className="list_link">Show Wait Listed Classes</button></li>
            <li><button className="list_link">Drop Classes</button></li>
            </ul>   
        </div>
        </div>
    )
